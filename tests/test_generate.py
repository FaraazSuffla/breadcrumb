...
class TestCrawlStatic:
    ...
    def test_crawl_static_element_fields(self, v1_elements: list[dict]) -> None:
        ...
        required_keys = {
            "tag", "type", "id", "name", "class", "text", "href",
            "placeholder", "aria_label", "data_testid", "value", "role", "selector",
        }
...
class TestClassifier:
    ...
    def test_classify_login_elements(
        self, classifier: ElementClassifier, v1_elements: list[dict],
    ) -> None:
...
class TestCodegen:
    ...
    def test_generate_page_object(self, codegen: TestCodeGenerator) -> None:
        elements = [
            {"tag": "input", "type": "email", "id": "email", "data_testid": "email",
             "selector": '[data-testid="email"]', "role": "email_input",
             "name": None, "class": None, "text": None, "href": None,
             "placeholder": "Email", "aria_label": None, "value": None},
            {"tag": "button", "type": "submit", "id": "login-btn", "data_testid": "login-submit",
             "selector": '[data-testid="login-submit"]', "role": "login_form",
             "name": None, "class": "btn", "text": "Sign In", "href": None,
             "placeholder": None, "aria_label": None, "value": None},
        ]
    ...
    def test_generate_page_object_class_name(self, codegen: TestCodeGenerator) -> None:
        elements = [
            {"tag": "button", "id": "ok", "selector": "#ok", "text": "OK",
             "type": None, "name": None, "class": None, "href": None,
             "placeholder": None, "aria_label": None, "data_testid": None,
             "value": None, "role": "button"},
        ]
    ...
    def test_generate_test_file(self, codegen: TestCodeGenerator) -> None:
        elements = [
            {"tag": "input", "type": "email", "id": "email", "data_testid": "email",
             ...
             "name": None, "class": None, "text": None, "href": None,
             "placeholder": "Email", "aria_label": None, "value": None},
            {"tag": "button", "type": "submit", "id": "submit", "data_testid": None,
             "selector": "#submit", "role": "submit",
             "name": None, "class": None, "text": "Submit", "href": None,
             "placeholder": None, "aria_label": None, "value": None},
        ]
    ...
    def test_generate_test_file_has_fill_test(self, codegen: TestCodeGenerator) -> None:
        elements = [
            {"tag": "input", "type": "text", "id": "username",
             "selector": "#username", "role": "text_input",
             "name": None, "class": None, "text": None, "href": None,
             "placeholder": None, "aria_label": None, "data_testid": None,
             "value": None},
        ]
...
class TestEndToEnd:
    ...
    def test_full_pipeline(
        self, crawler: PageCrawler, classifier: ElementClassifier, codegen: TestCodeGenerator,
    ) -> None:
